...
const HomeAppoinment = () => {
    return (
        <Box sx={{ width: '100%' , height:'600px' , background:'rgb(5 63 120 / 90%)' , backgroundImage : "url('https://images.pexels.com/photos/4386470/pexels-photo-4386470.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')" ,backgroundBlendMode:'darken' ,backgroundAttachment:'fixed' , backgroundPosition:'center'}}>
        <Container>
        ...
        <img style={{width:'100%', borderRadius:'10px'}} src="https://i.ibb.co/grV5ys4/pexels-anna-shvets-4167542-removebg-preview.png" alt="" />
        </Grid>
        <Grid item xs={12} md={6}>
